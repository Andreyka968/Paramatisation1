...
import org.example.com.exam.Computer;
import org.example.com.exam.computerName.NexusWave;
import org.example.com.exam.computerName.QuantumPulse;
...
public class Main {
    ...
    private static List<Computer> createdObject(String[] data) {
        ...
        for (int c = 2; c < data.length; c++) {
            ...
            switch (peaces[2]) {
                case "CyberNova_1":
                    sybernova = new com.example.computerName.CyberNova
                ...
                case "QuantumPulse_3":
                    ...
                    break;
                case "StellarByte_4":
                    sybernova = new com.example.computerName.StellarByte(Integer.parseInt(peaces[0]) , peaces[5] , peaces[2] , peaces[1] ,
                            peaces[4] , peaces[3] ,
                            Integer.parseInt(peaces[6]));
                    break;
                case "VirtuosoSystem_6":
                    sybernova = new com.example.computerName.VirtuosoSystem(Integer.parseInt(peaces[0]) , peaces[5] , peaces[2] , peaces[1] ,
                            peaces[4] , peaces[3] ,
                            Integer.parseInt(peaces[6]));
                    break;
                case "TechMaverick_5":
                    sybernova = new com.example.computerName.TechMaverick(Integer.parseInt(peaces[0]) , peaces[5] , peaces[2] , peaces[1] ,
                            peaces[4] , peaces[3] ,
                            Integer.parseInt(peaces[6]));
                    break;
            }
